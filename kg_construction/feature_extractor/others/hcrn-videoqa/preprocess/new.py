...
#from datautils import vggsound_qa
...
if __name__ == '__main__':
    ...
    # dataset info
    parser.add_argument('--dataset', default='vggsound-qa', choices=['tgif-qa', 'msvd-qa', 'msrvtt-qa', 'vggsound-qa'], type=str)
    ...
    if(args.dataset == 'vggsound-qa'):
        args.annotation_file = '/DATA/DATANAS1/hrz/dataset/VGGSound-QA/{}_qa.json'
        args.video_dir = '/DATA/DATANAS1/hrz/dataset/VGGSound-QA/video/'
        args.video_name_mapping = '/DATA/DATANAS1/hrz/dataset/VGGSound-QA/name2index_map.json'
        #video_paths = vggsound_qa.load_video_paths(args)
        import json
        with open("/DATA/DATANAS1/hrz/dataset/VGGSound-QA/video_list.json") as f:
            annotation = json.load(f)

        video_paths = [(os.path.join(args.video_dir, name+'.mp4'), i+1) for i,name in enumerate(annotation)]
